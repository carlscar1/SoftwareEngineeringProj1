...
public class Board {
	...
	spaces[0].owned = true; //Setting it to true so that nobody purchases it
	...
	spaces[9].owned = false;
	
	spaces[10].name = "Jail";
	spaces[10].description = "";
	spaces[10].owned = true;
	...
	public void resetAllOwnedSpaces() {
		for(int i=0; i < 40; i++) {
			//if(spaces[i].ownerName.equals("BANK")) {
