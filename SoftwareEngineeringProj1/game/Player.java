...
public class Player {
    ...
    /** gives each Player $750 as an integer to begin and 
     * keeps track of their money throughout game */
    int money = 750;

    /** starts each player at space 0 and keeps track of their 
    ...
    /** number to count get out of jail free cards. */
    int outOfJailFree = 0;
    
    /** boolean for if the given variable is type player. */
    ...
    /*****************************************************************
    Returns the integer number of get out of jail free cards that
    the given player has. 
    @return the number of get out of jail free cards that the player
    has
    *****************************************************************/
    ...
    /*****************************************************************
     Changes the player;s money count to the input parameter amount.
    @param money is the money that the player now has.
    *****************************************************************/
    ...
    /*****************************************************************
     Sets the isPlayer boolean to true or false based on if the
     input playerType is equal to "Player" (true) or not. 
     @param playerType is a string that will either have "Player" or
     not. 
    *****************************************************************/
    ...
    /*****************************************************************
    Returns the boolean value of the variable isPlayer.
    @return if isPlayer is true or false 
    *****************************************************************/
    ...
    /*****************************************************************
	Changes the integer number of get out of jail free cards based
	on the input parameter.
	@param cardsGained is the number of cards that the player won
	during that turn. 
    *****************************************************************/
    ...
    public void addMoney(int priceOfProperty) {
        ...
        //if the player is paying the money, 
        //just use a negative input instead
    }
    ...
    /*****************************************************************
    Adds a BoardSpace object to the arrayList of BoardSpace projects
    that are owned by the player. 
    @param occupied is the input of the BoardSpace object 
    *****************************************************************/
    ...
    public boolean ownsColorGroup (String color) {
        int tempColor = 0;
        int maxTemp;
        if(color.equals("purple") || color.equals("blue") || color.equals("utilities")) {
            maxTemp = 2;
        }
        ...
        for(int i = 0; i < getNamesOfProperties().size(); i++) {
            if((getNamesOfProperties().get(i)).getColorSet().equals(color)) {
                tempColor++;
            }
        }
    ...
    public int amountOfColor (String color) {
        int colorNum = 0;
        for(int i = 0; i < namesOfProperties.size(); i++) {
            if((namesOfProperties.get(i)).getColorSet().equalsIgnoreCase(color)) {
                colorNum++;
            }
        }
        return colorNum;
